...
int do_bdinfo ( cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	print_IPaddr (bd->bi_ip_addr);
	printf ("\nbaudrate    = %d bps\n", bd->bi_baudrate);
#ifdef	CONFIG_OR1K_DE2_70_MEM_SIZE
	printf ("CONFIG_SYS_MONITOR_BASE    = %x\n", CONFIG_SYS_MONITOR_BASE);
	printf ("CONFIG_SYS_MONITOR_LEN     = %x\n", CONFIG_SYS_MONITOR_LEN);
	printf ("CONFIG_SYS_MALLOC_BASE    = %x\n", CONFIG_SYS_MALLOC_BASE);
	printf ("CONFIG_SYS_MALLOC_LEN    = %x\n", CONFIG_SYS_MALLOC_LEN);
	printf ("CONFIG_SYS_INIT_SP    = %x\n", CONFIG_SYS_INIT_SP);
	printf ("CONFIG_SYS_GBL_DATA_OFFSET    = %x\n", CONFIG_SYS_GBL_DATA_OFFSET);
	printf ("CONFIG_SYS_GBL_DATA_SIZE    = %x\n", CONFIG_SYS_GBL_DATA_SIZE);
